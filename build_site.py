...
<header class="site-header">
  <nav class="nav" aria-label="Navigation principale">
    <a class="wordmark" href="index.html"><img class="wordmark-logo" src="assets/branding/bb16-studio-logo.jpg" alt="" width="56" height="56"><span>BB16 Studio</span></a>
...
def document(title: str, description: str, active: str, body: str, config: dict, filename: str) -> str:
    ...
    og_asset = {"convertair.html": "assets/branding/convertair-presentation.png", "doccipher.html": "assets/branding/doccipher-presentation.png", "hgq.html": "assets/apps/hgq-logo.png"}.get(filename, "assets/branding/bb16-studio-logo.jpg")
...
<head>
  ...
  <link rel="icon" type="image/jpeg" href="assets/branding/bb16-studio-logo.jpg">
