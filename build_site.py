...
<header class="site-header">
  <nav class="nav" aria-label="Navigation principale">
    <a class="wordmark" href="index.html"><span class="wordmark-mark" aria-hidden="true">B</span><span>BB16 Studio</span></a>
...
def footer() -> str:
  ...
  <span class="footer-links"><a href="privacy.html">Privacy</a><a href="legal.html">Legal</a><a href="contact.html">Contact</a></span>
</div></footer>'''
...
def document(title: str, description: str, active: str, body: str, config: dict, filename: str) -> str:
    ...
    og_image = page_url("assets/apps/convertair-icon-512.png", site_url, base_path)
...
def product_page(kind: str, config: dict) -> tuple[str, str]:
  ...
  <div class="prose"><p class="eyebrow">Coffre documentaire</p><h1>DocCipher</h1>
    <p class="lede">DocCipher explore un coffre documentaire local-first : vos papiers, votre clé, votre cloud configuré.</p>
    <p><span class="status pending">Android en développement</span></p>
    <h2>Chiffrement local et export maîtrisé</h2>
    <p>Le projet travaille sur un format de coffre chiffré, des opérations locales et des flux de sauvegarde ou de synchronisation WebDAV configurés par l'utilisateur. Il ne repose pas sur un backend documentaire BB16.</p>
...
def main() -> None:
    ...
    parser.add_argument("--import-assets", action="store_true", help="Importer explicitement les quatre assets depuis les projets source voisins")
